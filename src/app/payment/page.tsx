...
export default function PaymentPage() {
  ...
  return (
    <>
      ...
      <section className="relative py-20 md:py-28 bg-dark-900 min-h-screen overflow-hidden">
        ...
        <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6">
          ...
          {paid && (
            <motion.div
              ...
              className="premium-card rounded-2xl p-8 md:p-10 text-center border-green-500/20"
            >
