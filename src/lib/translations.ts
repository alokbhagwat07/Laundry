...
export const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    "booking.bookAndPay": "Book & Pay",
    "booking.payOnline": "Pay Online",
    "booking.cod": "Cash on Delivery",
    "booking.payLater": "Pay Later",
    "booking.selectPayment": "Select Payment Method",
    "booking.paymentOnlineDesc": "Pay via GPay, PhonePe, or Paytm",
    "booking.codDesc": "Pay when we pick up your laundry",
    "booking.payLaterDesc": "Pay after service is delivered",
    ...
    "contact.address": "Annapurna Mata Nagar, Wadgoan Road, Alandi Dewachi",
  ...
  mr: {
    ...
    "booking.bookAndPay": "बुक करा आणि पैसे द्या",
    "booking.payOnline": "ऑनलाइन पैसे द्या",
    "booking.cod": "डिलिव्हरीवर पैसे द्या",
    "booking.payLater": "नंतर पैसे द्या",
    "booking.selectPayment": "पेमेंट पद्धत निवडा",
    "booking.paymentOnlineDesc": "GPay, PhonePe, किंवा Paytm द्वारे पैसे द्या",
    "booking.codDesc": "पिकअपच्या वेळी पैसे द्या",
    "booking.payLaterDesc": "सेवा मिळाल्यानंतर पैसे द्या",
    "booking.processing": "पेमेंट प्रक्रिया करत आहे...",
    "booking.paymentFailed": "पेमेंट अयशस्वी. कृपया पुन्हा प्रयत्न करा.",
    "booking.paymentSuccess": "पेमेंट यशस्वी!",
    ...
    "contact.address": "अन्नपूर्णा माता नगर, वडगाव रोड, आळंदी देवाची",
    ...
    "admin.stat.revenue": "एकूण महसूल",
    "admin.paymentStatus": "पेमेंट स्थिती",
    "admin.paymentMethod": "पेमेंट पद्धत",
    "admin.paymentId": "पेमेंट आयडी",
    "admin.filterAll": "सर्व",
    "admin.filterPending": "प्रलंबित",
    "admin.filterPaid": "दिले",
    "admin.filterFailed": "अयशस्वी",
    "admin.filterRefunded": "परत केले",
