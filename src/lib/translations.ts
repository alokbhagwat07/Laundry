...
export const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    "booking.paymentOnlineDesc": "Pay via UPI, Cards, Net Banking, GPay, PhonePe, Paytm",
  ...
  mr: {
    ...
    "booking.paymentOnlineDesc": "UPI, कार्ड, नेट बँकिंग, GPay, PhonePe, Paytm द्वारे पैसे द्या",
